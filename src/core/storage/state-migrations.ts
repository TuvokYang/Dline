...
export async function migrateLegacyApiConfigurationToModeSpecific(_context: vscode.ExtensionContext) {
	Logger.log("Skipping legacy API configuration migration; active profiles are managed by api_profiles.json")
}
