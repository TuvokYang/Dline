...
import { McpDownloadResponse } from "@shared/proto/dline/mcp"
...
- Make sure you read the user's existing mcp_settings.json file before editing it with this new mcp, to not overwrite any existing servers.
