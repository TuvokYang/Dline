		...
		if (response.data?.data) {
			...
			for (const rawModel of rawModels) {
				...
				if (rawModel.id in huggingFaceModels) {
					...
					modelInfo.maxTokens = staticModel.capabilities?.maxTokens
					modelInfo.contextWindow = staticModel.capabilities?.contextWindow
					modelInfo.supportsImages = staticModel.capabilities?.supportsImages
					modelInfo.supportsPromptCache = staticModel.capabilities?.supportsPromptCache ?? false
					modelInfo.inputPrice = staticModel.pricing?.inputPrice
					modelInfo.outputPrice = staticModel.pricing?.outputPrice
