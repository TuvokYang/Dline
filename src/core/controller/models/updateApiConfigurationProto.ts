...
import { UpdateApiConfigurationRequest } from "@shared/proto/dline/models"
import {
...
export async function updateApiConfigurationProto(
	...
	try {
		...
		const convertedApiConfigurationFromProto = {
			...
			// planModeProfile/actModeProfile are now stored as Settings,
			// not in apiConfiguration. Managed by updateSettings.
