...
const prompts: Record<string, string> = {
	...
	skillDescription:
		"Load the full instructions for one advertised Skill. Call this tool once with the exact Skill name, then follow the returned instructions directly for the current task. Do not call it when the Skill was already injected through explicit instructions.",
	workflowDescription:
		"Load the full procedure for one advertised Workflow. Call this tool once with the exact Workflow name, then follow the returned steps in order. Do not call it when the Workflow was already injected through explicit instructions.",
