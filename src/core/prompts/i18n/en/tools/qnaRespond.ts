...
const prompts: Record<string, string> = {
	...
	nativeDescription: `[TURN-END] Use this tool whenever the user asks a question or requests clarification. This MUST be your first response tool for any user question — do NOT use attempt_completion or any other tool to answer questions. Do NOT use plan_mode_respond for answering questions — plan_mode_respond is ONLY for presenting and discussing implementation plans. Available in both PLAN and ACT modes.`,
