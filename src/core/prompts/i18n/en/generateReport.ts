...
The report should include relevant code snippets, architectural decisions, error analysis, or performance data as appropriate. After the user reviews the report, they will provide feedback or instructions for the next steps.`,
	...
	nativeDescription: `[TURN-END] Generate a structured technical report for user review. Pauses execution and waits for user response. Use for formal reports, summaries of findings, or technical analysis requiring user review before continuing.`,
