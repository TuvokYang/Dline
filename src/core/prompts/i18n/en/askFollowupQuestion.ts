...
const prompts: Record<string, string> = {
	...
	nativeDescription:
		"[TURN-END] Ask user a question for clarifying or gathering information needed to complete the task. For example, ask the user clarifying questions about a key implementation decision. You should only ask one question.",
	questionInstruction:
		"The question to ask the user. This should be a clear, specific question that addresses the information you need.",
	questionUsage: "Your question here",
	nativeQuestionInstruction: 'The single question to ask the user. E.g. "How can I help you?"',
	optionsInstruction:
