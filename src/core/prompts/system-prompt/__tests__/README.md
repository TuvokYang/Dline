...
First differences:
Line 23:
  - Expected: You are Dline, an AI assistant created by Anthropic.
  + Actual:   You are Dline, an AI coding assistant created by Anthropic.
...
4. **Update snapshots** if changes are correct: `npm run test:snapshot`
