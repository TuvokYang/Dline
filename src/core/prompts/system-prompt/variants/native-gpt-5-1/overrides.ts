...
const GPT5_1_AGENT_ROLE = (_context: SystemPromptContext) => getPrompt("nativeGpt51Overrides", "agentRole")

const GPT5_1_RULES = (_context: SystemPromptContext) => getPrompt("nativeGpt51Overrides", "rules")

const GPT5_1_TOOL_USE = (_context: SystemPromptContext) => getPrompt("nativeGpt51Overrides", "toolUse")

const GPT5_1_ACT_VS_PLAN = (context: SystemPromptContext) =>
...
const GPT5_1_OBJECTIVE = (context: SystemPromptContext) => {
...
const GPT5_1_FEEDBACK = (_context: SystemPromptContext) => getPrompt("nativeGpt51Overrides", "feedback")
