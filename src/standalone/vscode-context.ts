...
log(`DLINE_ENVIRONMENT: ${process.env.DLINE_ENVIRONMENT}`)
...
export function initializeContext(clineDir?: string) {
	...
	const EXTENSION_MODE = envFlagEnabled(process.env.IS_DEV) ? ExtensionMode.Development : ExtensionMode.Production
