...
`
	...
	describe("Basic Hook Execution", () => {
		...
		it("should execute hook successfully and return result", async () => {
		...
		it("should handle hook that requests cancellation", async () => {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
	...
	describe("Cancellable Hooks", () => {
		it("should support user cancellation for cancellable hooks", async () => {
			// mocha this.timeout removed — vitest uses testTimeout config: (isWindows ? 10000 : 5000)
		...
		it("should not allow cancellation for non-cancellable hooks", async () => {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
	...
	describe("Error Handling", () => {
		...
		it("should update message state on hook failure", async () => {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
	...
	describe("Message State Updates", () => {
		it("should create hook message with running status", async () => {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should update hook message to completed status on success", async () => {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
	...
	describe("Different Hook Types", () => {
		it("should execute TaskResume hook with correct input structure", async () => {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should execute UserPromptSubmit hook with correct input structure", async () => {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should execute TaskCancel hook as non-cancellable", async () => {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should execute Notification hook with attention payload", async () => {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
	...
	describe("Edge Cases", () => {
		it("should handle empty context modification", async () => {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should handle undefined optional fields in result", async () => {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
