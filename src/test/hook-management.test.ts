...
import { CreateHookRequest, DeleteHookRequest, ToggleHookRequest } from "../shared/proto/dline/file"
...
describe("Hook Management", () => {
	...
	let _stateManagerStub: any /* sinon.SinonStub → vitest */
	let getWorkspacePathsStub: any /* sinon.SinonStub → vitest */
	...
	beforeEach(async () => {
		...
		_stateManagerStub = vi.spyOn(StateManager, "get").mockReturnValue({
		...
		getWorkspacePathsStub = vi.fn().mockResolvedValue({
	...
	describe("createHook", () => {
		it("should create hook with correct template content", async function (this: any) {
		...
		it("should create hook with non-executable permissions (644)", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should throw error for invalid hook types", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should throw error if hook already exists", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should create parent directories if they don't exist", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should create workspace hook when isGlobal is false", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should create Notification hook with valid template", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
	...
	describe("deleteHook", () => {
		it("should delete existing hook file", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should throw error if hook doesn't exist", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should delete workspace hook when isGlobal is false", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
	...
	describe("toggleHook", () => {
		it("should make hook executable (chmod +x)", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should make hook non-executable (chmod -x)", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should work for workspace hooks", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should return updated hooks state", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
	...
	describe("refreshHooks", () => {
		it("should discover hooks in global directory", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should discover hooks in workspace directories", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should correctly identify executable vs non-executable hooks", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should return empty list when no hooks exist", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should include absolute paths in hook info", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should set isWindows flag correctly", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should resolve .ps1-only hooks on Windows (extensionless is unsupported)", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should ignore extensionless hook on Windows and use .ps1 only", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
	...
	describe("Edge Cases", () => {
		it("should handle missing .clinerules directory gracefully", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should handle permission errors gracefully", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should invalidate cache after hook operations", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
		...
		it("should toggle and delete .ps1-only hooks on Windows", async function (this: any) {
			// mocha this.timeout removed — vitest uses testTimeout config: (5000)
