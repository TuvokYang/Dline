...
describe("Dline Extension", () => {
	...
	it("should handle webview messages", async () => {
		...
		// Simulate the webview message by posting directly to the mock
		panel.webview.postMessage({ text: 'test-message' })
