import { AuthState, UserInfo } from "@shared/proto/dline/account"
import { type EmptyRequest, String } from "@shared/proto/dline/common"
...
export class AuthService {
	...
	async sendAuthStatusUpdate(): Promise<void> {
		...
		// Skip feature flags poll for unauthenticated users — defaults are sufficient
