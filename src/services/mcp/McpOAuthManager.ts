import { getAllMcpOAuthSecrets, setAllMcpOAuthSecrets } from "@core/storage/secrets"
...
function getMcpOAuthSecrets(): McpOAuthSecrets {
	return getAllMcpOAuthSecrets() as McpOAuthSecrets
}
