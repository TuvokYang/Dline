...
const AutoApproveModal: React.FC<AutoApproveModalProps> = ({ isVisible, setIsVisible, buttonRef, ACTION_METADATA }) => {
	...
	return (
		<div
			className="absolute bottom-full left-0 right-0 z-50 bg-(--vscode-editor-background) shadow-lg border border-(--vscode-panel-border) rounded"
			ref={modalRef}>
			<div
				...
				<div className="mb-2.5 text-muted-foreground text-xs cursor-pointer" onClick={() => setIsVisible(false)}>
					Let Dline take these actions without asking for approval.{" "}
					<a
						className="text-link hover:text-link-hover"
						href="https://docs.dline.bot/features/auto-approve#auto-approve"
						rel="noopener"
