...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: 'Enable "Double-Check Completion" in settings to have Dline verify its work before finishing a task.',
	},
	{
		text: "Add a .clinerules file to your project root to give Dline project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before Dline takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give Dline access to external tools and APIs.",
	},
	{
		text: "Dline creates checkpoints after changes — you can always restore to a previous state.",
	},
	{
	...
	{
		text: "Dline can browse websites — ask it to test your local dev server in the browser.",
	},
	{
