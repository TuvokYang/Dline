...
import type { Worktree } from "@shared/proto/dline/worktree"
import { TrackWorktreeViewOpenedRequest } from "@shared/proto/dline/worktree"
...
export const WelcomeSection: React.FC<WelcomeSectionProps> = ({
	...
	return (
		<div className="flex flex-col flex-1 w-full h-full p-0 m-0">
			...
			<div className={`overflow-hidden flex flex-col pb-2.5 ${shouldShowQuickWins ? "" : "flex-1 min-h-0"}`}>
								...
								{currentWorktree && (
									<Tooltip>
										...
										<TooltipContent side="bottom">
											View and manage git worktrees. Great for running parallel Dline tasks.
										</TooltipContent>
									</Tooltip>
								)}
							</div>
