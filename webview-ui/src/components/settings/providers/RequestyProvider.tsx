...
export const RequestyProvider = ({ showModelOptions, isPopup, profile, onUpdate }: RequestyProviderProps) => {
	const { models, defaultModelId, modelInfoSaneDefaults } = useProviderModels("requesty")
	...
	return (
		<div>
			<ApiKeyField
				...
				signupUrl="https://app.requesty.ai/"
			/>
			{showModelOptions && (
				<>
					<ModelSelector
