...
export const SambanovaProvider = ({ showModelOptions, isPopup, profile, onUpdate }: SambanovaProviderProps) => {
	const { models, defaultModelId, modelInfoSaneDefaults } = useProviderModels("sambanova")
