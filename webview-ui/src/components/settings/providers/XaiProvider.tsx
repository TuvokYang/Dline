...
export const XaiProvider = ({ showModelOptions, isPopup, profile, onUpdate }: XaiProviderProps) => {
	const { models, defaultModelId, modelInfoSaneDefaults } = useProviderModels("xai")
