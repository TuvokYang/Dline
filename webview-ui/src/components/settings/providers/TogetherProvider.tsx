...
export const TogetherProvider = ({ showModelOptions, isPopup, profile, onUpdate }: TogetherProviderProps) => {
	const { models, defaultModelId, modelInfoSaneDefaults } = useProviderModels("together")
