...
export const BasetenProvider = ({ showModelOptions, isPopup, profile, onUpdate }: BasetenProviderProps) => {
	const { models, defaultModelId, modelInfoSaneDefaults } = useProviderModels("baseten")
