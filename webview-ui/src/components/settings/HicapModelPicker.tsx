...
const HicapModelPicker: React.FC<HicapModelPickerProps> = ({ isPopup, currentMode }) => {
	...
	const handleModelChange = (newModelId: string) => {
		...
		handleModeFieldsChange(
			{
				hicapModelId: { plan: "planModeProfile", act: "actModeProfile" },
				hicapModelInfo: { plan: "planModeProfile", act: "actModeProfile" },
			},
			{
			...
			<div className="flex flex-col">
				...
				<div className="relative w-full" ref={dropdownRef}>
					<VSCodeTextField
						...
						disabled={(apiConfiguration as any)?.hicapApiKey?.length !== 32 || Object.keys(hicapModels).length === 0}
						id="model-search"
