...
const HuggingFaceModelPicker: React.FC<HuggingFaceModelPickerProps> = ({ isPopup }) => {
	const { apiConfiguration, huggingFaceModels: dynamicModels, setHuggingFaceModels, mode: currentMode } = useExtensionState()
	...
	const handleModelChange = (newModelId: string) => {
		...
		handleModeFieldsChange(
			{
				huggingFaceModelId: { plan: "planModeProfile", act: "actModeProfile" },
				huggingFaceModelInfo: { plan: "planModeProfile", act: "actModeProfile" },
			},
			{
