...
<Tabs>
  <Tab title="Adding Members">
    ...
    1. **Navigate to Members**
       - Go to your organization dashboard at app.dline.bot
...
<AccordionGroup>
  ...
  <Accordion title="Upgrading Your License" icon="arrow-up">
    Need more seats?
    - **Enterprise Plan:** Includes unlimited seats with no per-user restrictions. Contact your account manager or visit app.dline.bot/settings/billing to upgrade.
  </Accordion>
</AccordionGroup>
