...
You need admin privileges to enforce provider settings across your organization. If you can navigate to **Settings → Cline Settings** in the admin console at [app.dline.bot](https://app.dline.bot), you have the right access level.
...
<Frame>
	<img
		src="https://assets.int.dline.bot/assets/AWS%20Remote%20Config.gif"
	/>
</Frame>
...
Navigate to [app.dline.bot](https://app.dline.bot) and sign in with your administrator account. Go to **Settings → Cline Settings**.
