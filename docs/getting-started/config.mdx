...
```bash
export DLINE_DATA_DIR=/custom/path/to/cline
cline "your task"
```
...
|----------|-------------|
| `DLINE_DATA_DIR` | Custom data directory (replaces `~/.cline/data/`) |
...
| `DLINE_COMMAND_PERMISSIONS` | JSON policy restricting shell commands |
