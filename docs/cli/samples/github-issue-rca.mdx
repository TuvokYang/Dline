...
<Note>
**New to Cline CLI?** This sample assumes you have already completed the [Installation Guide](https://docs.dline.bot/getting-started/installing-cline) and authenticated with `cline auth`. If you haven't set up Cline CLI yet, please start there first.
</Note>
...
- **Cline CLI** installed and authenticated ([Installation Guide](https://docs.dline.bot/getting-started/installing-cline))
...
- [CLI Installation Guide](https://docs.dline.bot/getting-started/installing-cline)
- [CLI Reference Documentation](https://docs.dline.bot/cli/cli-reference)
- [Headless Mode](https://docs.dline.bot/usage/cli-overview#headless-mode)
