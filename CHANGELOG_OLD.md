...
- Subagent cancel button style and abort logic
- Documents path cache warmup at startup
- .cline → .dline path mismatch in test dirs
- AgentConfigLoader getInstance parameter
...
- Add lightbulb actions for selected text with options to "Add to Dline", "Explain with Cline", and "Improve with Cline"
...
- Cline now auto focuses the text field when using 'Add to Dline' shortcut
...
- Add 'Add to Dline' as an option when you right-click in a file or the terminal, making it easier to add context to your current task
- Add 'Fix with Dline' code action - when you see a lightbulb icon in your editor, you can now select 'Fix with Dline' to send the code and associated errors for Cline to fix. (Cursor users can also use the 'Quick Fix (CMD + .)' menu to see this option)
